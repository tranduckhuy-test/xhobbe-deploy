...
public class CartDAO extends AbstractDAO<Cart> implements ICartDAO {
    ...
    public List<Cart> findAll(int limit, int offset, String orderBy, String sortBy) {
        StringBuilder sql = new StringBuilder("SELECT s.*, p.\"name\", p.\"price\", p.\"stockQuantity\", MIN(pi.\"imageUrl\") AS selectedImageUrl ");
        ...
        sql.append("GROUP BY s.\"cartId\", s.\"userId\", s.\"productId\", p.\"name\", p.\"price\", p.\"stockQuantity\" ");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(c.getTotalItemByUserId(0));
    }
